...
> ⚠️ 注意：部分求職端資料夾（`1. 首頁`、`2. 搜尋頁`、`3. 公司頁`、`4. 職缺頁`、`A 主網`、`D 求職 AI 產品`）在工作區實際位於**最上層**，並未收納於「求職系統」資料夾下。
...
- 📁 **求才系統**
  ...
  - 📁 **B. 公司**
    ...
    - 📁 **B.2 帳號設定**
      ...
      - [B.2.1 基本資料](https://hackmd.io/@1111-jobdocs/BytSsxD8be)
...
- 📁 **求職系統**
  ...
  - 📁 **C 通訊功能**
    ...
    - [無標題](https://hackmd.io/@1111-jobdocs/B1z6PGXZzl)
