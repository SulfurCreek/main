...
- **實際展現 / In practice**：
  ...
  - **商業影響（付費客戶留存，已實證）**：與廠商 VIP 名冊（150,969 家）交叉比對——具名工單 **96.5% 來自開單當時付費中的客戶**，維運管線觸及 **1,109 家相異付費廠商帳號**；被服務客群**至今仍付費比例 85.5%**，約為全名冊基準（44.0%）的 **1.9 倍**（關聯非因果，詳見[證據頁](evidence-paying-customers.md)）——把維運從成本中心轉為**營收保護**。
