...
- **實際展現 / In practice**：
  ...
  - **商業影響（付費客戶留存，已帶對照組實證）**：以**兩份廠商名冊快照**（2026/04/30 與 07/07，相隔 68 天、交集 149,527 家）做世代比對——維運管線覆蓋 **1,279 家活躍付費廠商**（牌價年約當合約價值 **NT$3 千萬量級**），該客群**年化留存 81.2%，高於全站基準 74.2%**（**+7pt、流失相對降低 30%、p=0.011 顯著**），單一觀測窗口超額留存約 **NT$55 萬**合約價值；具名工單 **96.5% 來自開單當時付費中的客戶**，被服務客群至今仍付費 **86.1%**（全站同期 43.6%）。關聯非因果、且主張層級為「所治理的管線」而非個人親手帳號——詳見[證據頁](evidence-paying-customers.md)。把維運從成本中心轉為**營收保護**。
