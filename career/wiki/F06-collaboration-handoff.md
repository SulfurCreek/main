...
> **履歷叢集 / Résumé cluster**：Stakeholder Mgmt & Influence（見 `resume-craft` skill 核心職能叢集表）
...
**相關分頁 / Related**：[F9 利害關係人管理](F09-stakeholder-influence.md) ・ [F7 流程標準化與工具化](F07-process-tooling.md) ・ [旗艦專案 E.1（跨團隊協作）](flagship-e1.md)
