...
> **履歷叢集 / Résumé cluster**：Product Strategy & Vision（見 `resume-craft` skill 核心職能叢集表）
...
**相關分頁 / Related**：[F4 AI 產品企劃](F04-ai-product.md) ・ [旗艦專案 E.1（B↔C 跨系統）](flagship-e1.md) ・ [履歷可用摘要](resume-extract.md)
