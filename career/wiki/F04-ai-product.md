...
> **履歷叢集 / Résumé cluster**：AI Product（見 `resume-craft` skill 核心職能叢集表）
...
**相關分頁 / Related**：[F3 廠商端平台](F03-employer-platform.md) ・ [F10 業務邏輯梳理（規則→AI 判斷演進）](F10-business-logic.md) ・ [下一步補強建議（採用率數據）](growth-edges.md)
