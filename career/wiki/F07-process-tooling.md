...
> **履歷叢集 / Résumé cluster**：Process & Tooling（見 `resume-craft` skill 核心職能叢集表）
...
**相關分頁 / Related**：[F5 交付流程與品質](F05-delivery-quality.md) ・ [F6 跨職能協作與交接](F06-collaboration-handoff.md) ・ [履歷可用摘要](resume-extract.md)
