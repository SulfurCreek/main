...
KWMAP = [
    ...
    (r'內業工程|內業工程師|內業工程人員',                '內業工程人員'),
    (r'助理工程師|工程師助理|研發助理|工務助理工程師',   '工程助理'),
    (r'儀電.{0,4}工程師|機電.{0,4}工程師',              '機電技師／工程師'),
    (r'製圖工程師|繪圖工程師|CAD工程師',                 '機械設計／繪圖人員'),
    (r'FAC工程師|設備工程師|生產設備工程師',            '生產設備工程師'),
    (r'PCB.{0,4}工程師|PCB技術',                        'PCB技術人員'),
    (r'獸醫師|獸醫佐',                                   '獸醫／獸醫佐'),
    (r'髮型設計師|美髮設計師',                           '髮型設計師'),
